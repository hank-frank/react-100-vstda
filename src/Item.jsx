    ...
    render() {
                ...
                className={ `${ this.setPriorityColor(this.props.priority) } clearfix align-middle` }>
                    <input type='checkbox'
                        ...
                        <a className='edit-todo btn float-right text-success m-2 align-middle'
                            onClick={ () => this.props.clickEdit(this.props.title) }  //leaving off here. clickEdit isn't making it App => View => Item yet... props not being passed properly. pick up here. 
                            name='editButton'
        ...
        <div className="m-0"
            ...
            style={{ display: this.displayEdit(this.props.isBeingEdited) }}>
                {/* this.displayEdit(this.props.isBeingEdited) */}
            <li id="alert"
                name={ this.props.priority }
                className={ `${ this.setPriorityColor(this.props.priority) } clearfix align-middle` }>
                <div className="form-group m-4">
                   ...
                   <textarea 
                        ...
                        rows="5" id="comment" 
                        placeholder="Describe the stuff you need done..."></textarea>
                </div>
                <div className="form-group m-4">
